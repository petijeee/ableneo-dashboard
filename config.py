...
KR_TARGETS = {
    "KR1": {
        ...
        "baseline": None,           # Pull from MS Teams — update when known
        "target": None,             # +50% YoY — computed once baseline is set
    ...
    "KR3": {
        ...
        "yoyField": "KR3_Website_YoY",
        "yoyTarget": 60,            # target growth % for indicator
        "baseline": None,
        "target": 1.60,             # +60% YoY = 1.60 in decimal
    ...
    "KR6": {
        ...
        "baseline": None,           # Pull from ATS — update when known
        "target": None,             # +60% YoY
        "targetDisplay": "+60% YoY",
        "targetType": "yoy",
        "unit": "",
...
L_TARGETS = {
    ...
    "L2": {"label": "LinkedIn post avg impressions",        "field": "L2_Post_Avg_Impressions",   "target": None,   "unit": ""},
